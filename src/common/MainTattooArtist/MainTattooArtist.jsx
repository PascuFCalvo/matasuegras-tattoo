          ...
          <div className="gridTattooArtist">
            <div className="flexTattoArtist">
              ...
              <div>
                ...
                sonido de una Les Paul y el zumbido de las máquinas de tatuar.
                Su adicción al punk le lleva a crear su propio sello
                discográfico, Mongolic Records, aunque su verdadero oficio son
                las pieles.
              </div>
            </div>
            <div className="flexTattoArtist">
              <img
                className="tattooimage  dewis"
                id="col2"
                src={DewisConsin}
              ></img>
              ...
              <div>
                DonRogelio es un ilustrador y diseñador nacido en La Habana en
                el 87. Empieza a explorar el tattoo como otro soporte de
                expresión de la plástica. Por 2008 había muy poca escena del
                tattoo en Cuba.
              </div>
            </div>
            <div className="flexTattoArtist">
