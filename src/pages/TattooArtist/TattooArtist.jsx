   ...
   <div><div className="backgroundTattooArtist">
      <div className="gridTattooArtist">
        <div className="flexTattoArtist">
          <img className = "tattooimage" src={BlackAlien} onClick={() => 
          navigate("/tatuadores/blackAlien")
          }></img>
          ...
          <img className = "tattooimage" src={Sento}onClick={() => 
          navigate("/tatuadores/sento")
          }></img>
        ...
        <div className="flexTattoArtist">
          <img className = "tattooimage" src={DewisConsin}onClick={() => 
          navigate("/tatuadores/dewisConsin")
          }></img>
          ...
          <img className = "tattooimage" src={DonRogelio}onClick={() => 
          navigate("/tatuadores/donRogelio")
          }></img>
        ...
        <div className="flexTattoArtist">
          <img className = "tattooimage" src={Alice}onClick={() => 
          navigate("/tatuadores/alice")
          }></img>
