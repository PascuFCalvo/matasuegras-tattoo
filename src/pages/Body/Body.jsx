...
import { TattoArtistAppointments } from "../MainTattooPanelAppointments/TattooArtistAppointments";
  ...
  return (
    <>
      <Routes>
        ...
        <Route
          path="/myTattooPanel/tattooArtistAppointments"
          element={<TattoArtistAppointments />}
        />
        <Route path="/myUserPanel" element={<MainUserPanel />} />
        <Route
          path="/myUserPanel/UserPanelAppointments"
          element={<UserPanelAppointments />}
        />
        <Route
        ...
        />
        <Route
          path="/superAdmin/superAdminAppointments"
          element={<SuperAdminAppointments />}
        />
